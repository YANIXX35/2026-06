                ...
                <table width="520" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
                    ...
                    <tr>
                        <td style="padding:40px 40px 32px;">
                            <p style="font-size:1rem;color:#374151;margin:0 0 16px;">Bonjour,</p>
                            <p style="font-size:.95rem;color:#6b7280;margin:0 0 28px;line-height:1.6;">
                                Vous avez demandé à réinitialiser votre mot de passe. Voici votre code de vérification à usage unique. Il est valable <strong>10 minutes</strong>.
                            </p>
                            ...
                            <div style="text-align:center;margin:0 0 28px;">
                                <div style="display:inline-block;background:#f0fdf4;border:2px dashed #16a34a;border-radius:12px;padding:20px 48px;">
                                    ...
                                    <div style="font-size:.75rem;color:#6b7280;margin-top:6px;">Code OTP — valable 10 min</div>
                                </div>
                            </div>
