...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->enum('role', ['fournisseur', 'acheteur', 'admin'])->default('acheteur');
            ...
            $table->enum('type_structure', ['restaurant', 'marché', 'transformateur', 'artisan', 'éleveur', 'autre'])->nullable();
            ...
            $table->enum('type_acheteur', ['particulier', 'association', 'éleveur', 'autre'])->nullable();
